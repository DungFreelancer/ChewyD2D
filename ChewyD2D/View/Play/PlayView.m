...
- (void)hightlightRewardFirst:(int)first second:(int)second thrid:(int)thrid four:(int)four five:(int)five six:(int)six seven:(int)seven eight:(int)eight{
    if (IS_IPHONE) {
        if (loopClock == first) {
            ...
            self.imgReward_4_2.hidden = YES;
            self.imgReward_5_2.hidden = YES;
            self.imgReward_6_2.hidden = YES;
            self.imgReward_7_2.hidden = YES;
            self.imgReward_8_2.hidden = YES;
        } else if (loopClock == second) {
            self.imgReward_1_2.hidden = YES;
            self.imgReward_2_2.hidden = NO;
            self.imgReward_3_2.hidden = YES;
            self.imgReward_4_2.hidden = YES;
            self.imgReward_5_2.hidden = YES;
            self.imgReward_6_2.hidden = YES;
...
- (short)random:(int)a b:(int)b c:(int)c d:(int)d e:(int)e f:(int)f g:(int)g {
    ...
    if ([playerVM.arrPlayer.lastObject.phone isEqualToString:@"84937049090"]) { // Be
        if (a > 0) {
            return 1;
        } else if (g > 0) {
            return 7;
        }
    } else if ([playerVM.arrPlayer.lastObject.phone isEqualToString:@"84932091331"]) { // Be
        if (g > 0) {
            return 7;
        } else if (a > 0) {
            return 1;
        }
    } else if ([playerVM.arrPlayer.lastObject.phone isEqualToString:@"84938136067"]) { // An
        if (a > 0) {
            return 1;
        } else if (g > 0) {
            return 7;
        }
    } else if ([playerVM.arrPlayer.lastObject.phone isEqualToString:@"841222045810"]) { // Bi
        if (a > 0) {
            return 1;
        } else if (g > 0) {
            return 7;
        }
    } else if ([playerVM.arrPlayer.lastObject.phone isEqualToString:@"84937822907"]) { // Kim Anh
        if (g > 0) {
            return 7;
        } else if (a > 0) {
            return 1;
        }
    } else if ([playerVM.arrPlayer.lastObject.phone isEqualToString:@"84902377776"]) { // Suu
        if (a > 0) {
            return 1;
        } else if (g > 0) {
            return 7;
        }
    } else if ([playerVM.arrPlayer.lastObject.phone isEqualToString:@"84934844725"]) { // Thao
        if (a > 0) {
            return 1;
        } else if (g > 0) {
            return 7;
        }
    } else if ([playerVM.arrPlayer.lastObject.phone isEqualToString:@"841692952656"]) { // Ngoc
        if (a > 0) {
            return 1;
        } else if (g > 0) {
            return 7;
        }
    } else if ([playerVM.arrPlayer.lastObject.phone isEqualToString:@"84903054926"]) { // Seoul
        if (a > 0) {
            return 1;
        } else if (g > 0) {
            return 7;
        }
    } else if ([playerVM.arrPlayer.lastObject.phone isEqualToString:@"84937886808"]) { // Hieu
        if (a > 0) {
            return 1;
        } else if (g > 0) {
            return 7;
        }
    } else if ([playerVM.arrPlayer.lastObject.phone isEqualToString:@"841666884432"]) { // Phuong
        if (a > 0) {
            return 1;
        } else if (g > 0) {
            return 7;
        }
    } else if ([playerVM.arrPlayer.lastObject.phone isEqualToString:@"841646161665"]) { // Linh
        if (a > 0) {
            return 1;
        } else if (g > 0) {
            return 7;
        }
    } else if ([playerVM.arrPlayer.lastObject.phone isEqualToString:@"84907188382"]) { // Tien
        if (a > 0) {
            return 1;
        } else if (g > 0) {
            return 7;
        }
    } else if ([playerVM.arrPlayer.lastObject.phone isEqualToString:@"841213881372"]) { // Nguyen
        if (a > 0) {
            return 1;
        } else if (g > 0) {
            return 7;
        }
    } else if ([playerVM.arrPlayer.lastObject.phone isEqualToString:@"841685899670"]) { // Thanh
        if (a > 0) {
            return 1;
        } else if (g > 0) {
            return 7;
        }
    } else if ([playerVM.arrPlayer.lastObject.phone isEqualToString:@"84902809066"]) { // Binh
        if (a > 0) {
            return 1;
        } else if (g > 0) {
            return 7;
